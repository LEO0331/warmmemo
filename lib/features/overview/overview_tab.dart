          ...
          child: Column(
            ...
            children: [
              const PageHero(
                ...
                title: '在失去親人的當下，不用邊掉眼淚邊談價格。',
                subtitle:
                    '暖備 WarmMemo 協助家屬在平常先了解流程、預先設定偏好。需要時以「固定價格 + 透明內容」媒合合作禮儀公司，減少匆忙比價與資訊不對稱。',
                badges: ['白話知識', '流程整理', '固定方案觀念'],
              ),
                ...
                child: Column(
                  ...
                  children: [
                    _BookLinkTile(
                      ...
                      onTap: () =>
                          _openExternal('https://www.diewithzerobook.com/'),
                    ),
                    ...
                    _BookLinkTile(
                      ...
                      onTap: () =>
                          _openExternal('https://fiveinvitations.com/'),
                    ),
                  ],
                ),
              ),
